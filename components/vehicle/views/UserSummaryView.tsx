          ...
          <table className="min-w-full text-[11px] sm:text-xs md:text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-2 sm:px-3 py-2 text-center font-medium text-gray-600">삭제</th>
              </tr>
            </thead>
            <tbody>
                ...
                filteredMyBookings.map((b) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-2 py-2 text-center whitespace-nowrap">{b.startTime}</td>

                      <td className="px-2 py-2 text-center whitespace-nowrap">{b.endTime}</td>

                      <td className="px-2 py-2 text-center">{b.destination}</td>
