  ...
  return (
    <div className="p-3 sm:p-4">
      ...
      <div className="grid grid-cols-7 gap-1 sm:gap-2">
        {blanks.map((_, i) => (
          <div key={`blank-${i}`} className="h-24 sm:h-32 bg-gray-50 rounded-lg" />
        ))}
        ...
        {dayNumbers.map((day) => {
          ...
          return (
            <div
              ...
              className={`h-24 sm:h-32 border rounded-lg p-2 sm:p-2.5 md:p-3 cursor-pointer transition-all hover:shadow-md hover:border-blue-300 bg-white relative ${
