        ...
        <table className="min-w-full text-[11px] sm:text-xs md:text-sm">
          <thead className="bg-gray-100 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-2 sm:px-3 py-2 text-center font-medium text-gray-600">신청차량</th>
              <th className="px-2 sm:px-3 py-2 text-center font-medium text-gray-600">신청자</th>
              <th className="px-2 sm:px-3 py-2 text-center font-medium text-gray-600">부서</th>
              ...
              <th className="px-2 sm:px-3 py-2 text-center font-medium text-gray-600">출장지역</th>
              <th className="px-2 sm:px-3 py-2 text-center font-medium text-gray-600">출장목적</th>
              ...
              filteredBookings.map((b) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 py-2 align-middle text-center">{b.destination}</td>

                    <td className="px-2 py-2 align-middle text-center">{b.purpose}</td>
                    ...
                    <td className="px-2 py-2 align-middle text-center">
                      {showLogButton && (
                        <button
                          ...
                          className={`px-2 py-1 rounded-full text-[10px] sm:text-xs font-semibold transition-all ${
                            hasLog
