...
export const UnauthorizedScreen: React.FC<UnauthorizedScreenProps> = ({ email, onLogout }) => (
  <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4 sm:px-6 lg:px-8">
    <div className="bg-white px-6 py-8 sm:px-8 sm:py-10 rounded-2xl shadow-lg w-full max-w-sm sm:max-w-md lg:max-w-lg text-center">
      ...
      <button onClick={onLogout} className="text-blue-600 hover:underline text-sm sm:text-base">
        로그아웃
      </button>
    </div>
  </div>
