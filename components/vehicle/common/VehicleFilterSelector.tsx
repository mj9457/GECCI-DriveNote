    ...
    return (
        <div className="flex flex-wrap items-center gap-1.5 text-[11px] sm:text-xs">
            ...
            <button
                ...
                className={`px-2 py-0.5 rounded-full border ${value === 'all'
            ...
            <button
                type="button"
                onClick={() => onChange('v1')}
                className={`px-2 py-0.5 rounded-full border ${value === 'v1'
            ...
            <button
                type="button"
                onClick={() => onChange('v2')}
                className={`px-2 py-0.5 rounded-full border ${value === 'v2'
